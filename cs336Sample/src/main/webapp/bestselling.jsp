...
<br>
	...
	try {
		...
		out.print("<p><strong><font size = '+3'>Best Selling Items</font></strong></p>");

		String str1 = "select type, count(type) as count from clothing  where is_available = 0 and current_bidder IS NOT NULL  group by type order by count desc;";
		...
		out.print("<p><font size = '+2'> Category: </font></p>");
		out.print("</td>");
		//make a column
		out.print("<td>");
		out.print("<p><font size = '+2'> # of items sold: </font></p>");
		out.print("</td>");
		out.print("</tr>");
